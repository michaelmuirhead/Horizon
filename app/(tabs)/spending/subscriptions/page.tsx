...
function buildTrackHref(c: SubscriptionCandidate): string {
  // Charges in the source data are stored as positive magnitudes on the
  // candidate; the form expects a signed amount, so negate for outflow.
...
export default function SubscriptionsPage() {
  ...
  const detectedMonthlyTotal = totalMonthlySubscriptions(
    undetectedCandidates,
  );
